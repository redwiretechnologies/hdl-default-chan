...
ad_ip_instance default_chan_block default_chan_block
ad_ip_parameter default_chan_block CONFIG.CLK_FREQ 100000000
...
# default_chan_block -> AD9361
ad_connect default_chan_block/adc_overflow axi_ad9361/adc_dovf
ad_connect default_chan_block/dac_underflow axi_ad9361/dac_dunf

# default_chan_block <-> concat
ad_connect concat_9361/adc_data default_chan_block/adc_data
ad_connect concat_9361/adc_enable default_chan_block/adc_enable
ad_connect concat_9361/adc_valid default_chan_block/adc_valid

ad_connect default_chan_block/dac_data concat_9361/dac_data
ad_connect concat_9361/dac_enable default_chan_block/dac_enable
ad_connect concat_9361/dac_valid default_chan_block/dac_valid

# DAC_DMA -> default_chan_block
ad_connect axi_ad9361_dac_dma/m_axis default_chan_block/s_dac_dma

# default_chan_block -> ADC_DMA
ad_connect default_chan_block/m_adc_dma axi_ad9361_adc_dma/s_axis

# pps
ad_connect pps default_chan_block/pps

# Test Block: Clock and Resets
ad_connect axi_ad9361/l_clk default_chan_block/adc_clk
ad_connect axi_ad9361/l_clk default_chan_block/dac_clk
ad_connect sys_user_clk default_chan_block/user_clk
ad_connect sys_user_clk default_chan_block/m_adc_dma_aclk
ad_connect sys_user_clk default_chan_block/s_dac_dma_aclk
ad_connect sys_user_clk axi_ad9361_dac_dma/m_axis_aclk
ad_connect sys_user_clk axi_ad9361_adc_dma/s_axis_aclk

ad_connect adc_clk_reset/peripheral_aresetn default_chan_block/adc_rstn
ad_connect adc_clk_reset/peripheral_aresetn default_chan_block/dac_rstn
ad_connect sys_user_resetn default_chan_block/user_resetn
ad_connect sys_user_resetn default_chan_block/m_adc_dma_aresetn
ad_connect sys_user_resetn default_chan_block/s_dac_dma_aresetn
...
ad_cpu_interconnect 0x7D000000 default_chan_block
